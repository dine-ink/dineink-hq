...
export default function Transitions({ children, position = 'top-left', type = 'grow', direction = 'up', ref, ...others }: TransitionsProps) {
  let positionSX = {
...
export function PopupTransition({ ref, ...props }: PopupTransitionProps) {
