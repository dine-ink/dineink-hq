import { ChartPieIcon, ReceiptPercentIcon, UserGroupIcon } from "@heroicons/react/24/solid";
...
export default function DashboardPreviewSection() {
  ...
  return (
    <div className="mx-auto mt-32 max-w-7xl sm:mt-56 sm:px-6 lg:px-8">
      <div className="relative isolate overflow-hidden rounded-[32px] bg-gradient-to-br from-red-900 via-rose-900 to-slate-900 px-6 py-20 shadow-2xl sm:px-10 sm:py-24 lg:px-16 lg:py-24">
        ...
        <div className="lg:max-w-xl">
            <div className="inline-flex items-center rounded-full border border-red-400/30 bg-red-500/10 px-4 py-1 text-sm font-medium text-red-200 backdrop-blur-sm">
            ...
            Manage orders, billing, menu, staff, reports and customer flow from
            one single dashboard designed for restaurants.
            </p>
        ...
        <div className="relative">
          <div className="absolute -top-8 -left-8 h-40 w-40 rounded-full bg-red-600/20 blur-3xl" />
