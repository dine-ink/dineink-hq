    ...
    <div className="mx-auto mt-32 max-w-7xl sm:mt-56 sm:px-6 lg:px-8">
      <div className="relative isolate overflow-hidden rounded-[32px]bg-[#b10000] px-6 py-24 shadow-2xl sm:px-24 xl:py-32">
        ...
        <form className="mx-auto mt-10 flex max-w-xl flex-col gap-4 sm:flex-row">
          ...
          <button
            type="submit"
            className="rounded-xl bg-red-700 px-6 py-4 text-sm font-semibold text-white shadow-lg transition duration-300 hover:bg-[#b10000]"
          >
            Get Started Free
          </button>
        </form>
        ...
        <div className="mt-8 flex flex-wrap items-center justify-center gap-6 text-sm text-gray-300">
          <div className="flex items-center gap-2">
            <span className="h-2 w-2 rounded-full bg-[#b10000]" />
