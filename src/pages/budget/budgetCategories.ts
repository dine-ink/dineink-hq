...
export const BUDGET_CATEGORIES: BudgetCategoryDef[] = [
  ...
  { key: "marketing", label: "Marketing", unit: "currency", group: "Fixed & Operating Costs" },
  { key: "maintenance", label: "Maintenance", unit: "currency", group: "Fixed & Operating Costs" },
  { key: "cleaning", label: "Cleaning", unit: "currency", group: "Fixed & Operating Costs" },
  { key: "packaging", label: "Packaging", unit: "currency", group: "Fixed & Operating Costs" },
  { key: "deliveryCommission", label: "Delivery Commission", unit: "currency", group: "Fixed & Operating Costs" },
  ...
  { key: "cashFlow", label: "Cash Flow", unit: "currency", group: "Profitability" },
];

export const BUDGET_CATEGORY_GROUPS = [...new Set(BUDGET_CATEGORIES.map((c) => c.group))];

export const MONTH_NAMES = ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"];

/** Apr(fyStartYear) .. Mar(fyStartYear+1), matching the backend's FY convention. */
export const fyMonths = (fyStartYear: number): { year: number; month: number }[] => {
...
export const fmtCategoryValue = (value: number | null | undefined, unit: BudgetCategoryDef["unit"]): string => {
