...
export default function MenuManagement() {
  ...
  // The Analytics tab still lives on this page and reads these three by name;
  // Restock takes the whole object.
  const { ingredientAnalytics, avgRecipeCost, avgProfitMargin,
    avgFoodCost, totalConsumptionValue } = analytics;
