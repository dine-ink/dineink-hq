...
export default function NotFound() {
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-gray-50 px-4 text-center">
      <div className="flex h-20 w-20 items-center justify-center rounded-3xl bg-gradient-to-br from-red-500 to-rose-500 shadow-xl">
        <span className="text-3xl font-black text-white">D</span>
      </div>
      <h1 className="mt-6 text-[5rem] font-black leading-none tracking-tight text-gray-900">404</h1>
